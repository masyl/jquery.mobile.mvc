	...
	$.mobile.changePage = function( to, transition, reverse, changeHash, fromHashChange ){
		...
		function transitionPages() {
			...
			if( from ){
				...
				//PATCH BY MATHIEU SYLVAIN TO RECEIVE PARAMS CORRECTLY
				from.data( "page" )._trigger( "beforehide", null, { nextPage: to } );
			}
			//PATCH BY MATHIEU SYLVAIN TO RECEIVE URL CORRECTLY
			to.data( "page" )._trigger( "beforeshow", null, { url: url, prevPage: from || $("") } );
		...
		//if url is a string
		if( url ){
			// PATCH TO SUPPORT ARGUMENTS - MATHIEU SYLVAIN
			//to = $( "[data-url='" + url + "']" );
		...
		if( !o.nativeMenu ){	
			var options = select.find("option"),
				...
				menuPage = $( "<div data-role='dialog' data-theme='"+ o.menuPageTheme +"'>" +
							...
							"</div>"+
							"<div darefreshta-role='content'></div>"+
						"</div>" )
						.appendTo( $.mobile.pageContainer )
						.page(),
